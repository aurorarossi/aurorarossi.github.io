...
#### Invited participant Dagstuhl Seminar on "Temporal Graphs: Structure, Algorithms, Applications" (2026)
 I am invited to participate in the Dagstuhl Seminar on ["Temporal Graphs: Structure, Algorithms, Applications"](https://www.dagstuhl.de/26251) held at Schloss Dagstuhl, Germany. This seminar gathers leading researchers in the field of temporal graphs to discuss
recent advances and future directions.



## Conferences and Reviewing activity
...
d’Azur, France. I was supervised by Samuel Deslauriers-Gauthier and Emanuele Natale. I explored the use of
hyperbolic random graph model as null model for the analysis of brain networks. This work led to the publication of a
paper in the Network Neuroscience journal.




## Internship and Summer of Code programs
...
#### French National Qualification for Associate Professor (Maître de Conférences) *2026* 
Awarded by the French National Council of Universities (CNU) in Computer Science, section 27. This qualification is a prerequisite for applying to permanent academic positions in France as an Associate Professor (Maître de Conférences). The qualification is valid for a period of four years.
